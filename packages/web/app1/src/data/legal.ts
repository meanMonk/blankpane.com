...
export const legalPages: LegalPage[] = [
  {
    slug: "about",
    title: "About FullScreenColor",
    lede: "FullScreenColor is a free, no-install browser tool for filling your screen with a solid color and downloading color swatches as high-quality PNG images.",
    sections: [
  ...
  },
  {
    ...
    lede: "This Privacy Policy explains what data FullScreenColor collects and how it is used.",
    sections: [
  ...
  },
  {
    ...
    lede: "By using FullScreenColor you agree to these simple terms.",
    sections: [
  ...
  },
  {
    slug: "cookie-policy",
    title: "Cookie Policy",
    lede: "How cookies are used on FullScreenColor.",
    sections: [
  ...
  },
  {
    slug: "disclaimer",
    title: "Disclaimer",
    lede: "General information and disclaimers about FullScreenColor.",
    sections: [
  ...
  },
  {
    ...
    sections: [
      { h: "Email", body: "hello@blank-screen.pages.dev — we reply as soon as we can." },
